    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUser", x => new { x.CompletedCoursesId, x.StudentsId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalProfession = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedCoursesId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedCourse", x => new { x.SavedCoursesId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserSavedCourse_Courses_SavedCoursesId",
                        column: x => x.SavedCoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "UserSavedVacancy",
                columns: table => new
                {
                    SavedVacanciesId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedVacancy", x => new { x.SavedVacanciesId, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentVacancyId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "text", nullable: false),
                    WorkingConditions = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VacancyApplications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedCourse_UserId",
                table: "UserSavedCourse",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSavedVacancy_UserId",
                table: "UserSavedVacancy",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CurrentVacancyId",
                table: "Users",
                column: "CurrentVacancyId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Courses_Users_EmployerId",
                table: "Courses",
                column: "EmployerId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_UserSavedCourse_Users_UserId",
                table: "UserSavedCourse",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_UserSavedVacancy_Users_UserId",
                table: "UserSavedVacancy",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_UserSavedVacancy_Vacancies_SavedVacanciesId",
                table: "UserSavedVacancy",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_Vacancies_CurrentVacancyId",
                table: "Users",
                column: "CurrentVacancyId",
                principalTable: "Vacancies",
                principalColumn: "Id");
